...
pub use auth::{
    ApiError, AuthConfig, AuthMethod, AuthenticatedUser, SupabaseJwtClaims, UserMetadata,
    authenticate_api_key, authenticate_jwt, check_scope, extract_bearer_token, guess_token_type, 
    hash_api_key, validate_jwt_token, TokenType,
};

pub use middleware::{
    AuthStrategy, api_key_middleware, jwt_middleware, require_scope,
};